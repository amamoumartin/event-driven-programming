...
namespace Game.SnakeGame.Test;

[TestClass]
public class UnitTest1
{
    private SnakeGameModel.SnakeGameModel ? testModel;

    [TestInitialize]
    public void Initialize()
    {
        testModel = new SnakeGameModel.SnakeGameModel(new DataAccess());
        //testModel.ScoreWriter += new EventHandler<GameEventArgs>(TestModel_GameAdvanced);
        //testModel.OnGameOver += new EventHandler<GameEventArgs>(TestModel_GameOver);
    }
